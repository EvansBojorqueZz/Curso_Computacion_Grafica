...
int main() {
	...
	float vertices[] = {
		...
		X_GL(349), Y_GL(631), 0.0f, 0.15f, 0.11f, 0.12f, // 103 (Vértice 99)
		...
		// Polígono S 
		X_GL(561), Y_GL(627), 0.0f, 0.15f, 0.11f, 0.12f, // 111 (Vértice 107)
		X_GL(329), Y_GL(791), 0.0f, 0.15, 0.11f, 0.12f, // 112 (Vértice 108)
		X_GL(253), Y_GL(739), 0.0f, 0.15f, 0.11f, 0.12f, // 113 (Vértice 109)

		// Polígono T
		X_GL(253), Y_GL(739), 0.0f, 0.8f, 0.0f, 0.04f, // 114 (Vértice 110) (11)
		X_GL(217), Y_GL(717), 0.0f, 0.8f, 0.0f, 0.04f, // 115 (Vértice 111) (13)
		X_GL(269), Y_GL(628), 0.0f, 0.8f, 0.0f, 0.04f, // 116 (Vértice 112)	(14)
		X_GL(270), Y_GL(660), 0.0f, 0.8f, 0.0f, 0.04f, // 117 (Vértice 113)	(6)
		X_GL(337), Y_GL(710), 0.0f, 0.8f, 0.0f, 0.04f, // 118 (Vértice 114)	(5)

		// Polígono U
		X_GL(329), Y_GL(791), 0.0f, 0.8f, 0.0f, 0.04f, // 119 (Vértice 115) 
		X_GL(217), Y_GL(717), 0.0f, 0.8f, 0.0f, 0.04f, // 120 (Vértice 116)	
		X_GL(232), Y_GL(863), 0.0f, 0.8f, 0.0f, 0.04f, // 121 (Vértice 117)	
		X_GL(155), Y_GL(849), 0.0f, 0.8f, 0.0f, 0.04f, // 122 (Vértice 118)	
