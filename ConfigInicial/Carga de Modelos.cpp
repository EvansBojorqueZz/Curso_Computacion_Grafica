...
// Posicion vertical del perro (Espacio = subir, Shift = bajar)
GLfloat dogY = 0.0f;
const GLfloat DOG_SPEED = 1.5f;   // unidades por segundo
...
void DoMovement()
{
    ...
    // Subir el perro con Espacio
    if (keys[GLFW_KEY_SPACE])
    {
        dogY -= DOG_SPEED * deltaTime;
    }

    // Bajar el perro con Shift (izquierdo o derecho)
